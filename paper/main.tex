...
(Cliff's $\delta = -0.355$ for P1 vs.\ P2; median-difference bootstrap 95\% CI $[0.078, 0.111]$; Table~\ref{tab:stats}),
...
for Mann-Whitney $U$):
$\delta = 2U_A/(n_1 n_2) - 1$, where $U_A$ is the $U$ statistic for
...
Control (Cliff's $\delta = -0.124$ for Ctrl vs.\ P1; see Table~\ref{tab:stats}), though both
...
(here, positive means first-listed group $>$ second-listed group), whereas
the bootstrap CI estimates the location shift of the median difference.
Effect-size interpretation: $\delta = -0.355$ (P1 vs.\ P2) is moderate-to-large in
magnitude and indicates P2 $>$ P1; $\delta = -0.124$ (Ctrl vs.\ P1) is small but
statistically reliable with $n > 2000$;
