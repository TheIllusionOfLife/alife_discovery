...
viability-only selection}, where the only filtering criterion is physical
...
analogous to minimal physical constraints: it constrains what is possible
without specifying what is desirable. Importantly, this negative selection
does constitute a minimal selection pressure (surviving rules must avoid
...
random rules, discard only physically broken ones, and ask what structure the
