...
5{,}000 simulations yielding 7M entity observations and 282 unique
...
\begin{itemize}
    ...
    occupancy)
    \item \textbf{Grid size}: $20 \times 20$ and $40 \times 40$
...
uses unique entity hashes (282 types), while instance-level uses all 7M
...
magnitude. The 210 new types observed in the large-scale run (vs.\ 72 in
...
7M observations, zero entities exhibit significant excess assembly under
...
\begin{figure}[t]
    ...
    \caption{
        ...
        with empirical $p$-values. Zero entities (0 of 7M) show
...
entities, but the assembly index remains size-driven. The $40 \times 40$
...
$40 \times 40$, and drift probabilities from 0.25 to 1.0. The catalytic
...
objective-free artificial life system. Across 5{,}000 simulations, 7M
