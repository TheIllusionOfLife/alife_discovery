...
197 observed entity types (up to 6 nodes).
...
\textbf{Parameter sweep.} Across all 20 conditions (8
density$\times$grid + 12 density$\times$drift), the empirical excess rate
