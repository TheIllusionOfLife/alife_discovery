...
Density sweep analysis, multi-seed robustness results, halt-window
sensitivity, survival rate confidence intervals, alternative null models,
spatial scrambling analysis, transfer entropy, capacity-matched controls,
space-time plots, and algorithmic pseudocode are available as
supplementary material with the code repository.
