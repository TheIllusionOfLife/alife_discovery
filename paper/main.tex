...
Ctrl vs.\ P1    & P1 $>$ Ctrl & 5000 & 5000 & 0.124 & [0.000, 0.000] & $< 10^{-50}$ \\
...
\begin{table}[htbp]
\centering
\caption{Density sweep results across 12 conditions (MI values are
Miller-Madow corrected, bits). Phase~2 achieves
...
Shuffle-null MI and $\mathrm{MI}_{\mathrm{excess}}$ confirm these patterns
hold after bias calibration (data available in supplementary materials).}
