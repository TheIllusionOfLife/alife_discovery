...
Remaining untested extensions include spatially-oriented rules and
rule evolution, which would further disentangle expressiveness from
randomness.
...
non-trivial assembly. Under both edge-removal and reuse-aware AT
formulations, and across parameter sweeps, partner-specific rules, and
motif-gated catalysis, assembly indices are fully explained by entity
size with zero significant excess. Within this rule class, structural
bias in the rules appears necessary for emergent complexity even
without explicit fitness functions
\citep{fanelli2012negativeresults}. This boundary condition provides a
concrete experimental baseline against which richer rule
representations and objective-free interventions can be measured.
