...
each joining edge $e \in E$, we partition the remaining edges
$S_1 \cup S_2 = E \setminus \{e\}$ into two sub-objects; when
$S_1 \cong S_2$ (isomorphic by canonical key), the duplicate is free:
\begin{equation}
...
mean bond formation probability. Death rates $d_k$ increase with $k$
...
This robust negative result establishes that, under low-expressiveness
random bonding rules, emergent structural complexity does not arise
from local interactions alone. Structural bias in the rules---whether
