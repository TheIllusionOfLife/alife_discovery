...
> **ドキュメント種別**: 初期提案書（Original Proposal）
> **位置づけ**: 本プロジェクトの出発点となるドキュメント。研究の背景・問い・基本戦略・最小世界モデルの初期設計を記述する。
>
> **関連ドキュメント**:
> - → [`unified_review.md`](unified_review.md) — 本ドキュメントに対する研究者レビュー。理論的懸念点・実験設計の問題点を重大度順に整理。
> - → [`spec.md`](spec.md) — レビューの指摘と研究意図を踏まえて策定した正式な実装仕様書。**実装時はこちらに従うこと。**
